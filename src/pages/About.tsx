        ...
        <div className={styles.container}>
          ...
          <div className={styles.teamGrid}>
            ...
            >
              ...
              <div>
                <h3 className={styles.teamMemberName}>Sarah Chen</h3>
                <p className={styles.teamMemberRole}>
                ...
                <div className={styles.socialLinks}>
                  ...
                  <a href="#" className={styles.socialLink}>
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c5.51 0 10-4.48 10-10S17.51 2 12 2zm-1.41 7.08c.84-.58 1.87-.92 2.98-.92 1.04 0 1.99.29 2.81.77l-1.39 1.39c-.43-.18-.9-.28-1.42-.28-1.79 0-3.24 1.29-3.55 2.99l-1.93-.38c.37-1.54 1.34-2.83 2.5-3.57zm3.99 10.85c-3.87 0-7-3.13-7-7s3.13-7 7-7c.49 0 .97.05 1.43.15l-1.43 1.43c-3.39.49-5.75 3.53-5.04 7.01l4.13-4.13 1.58 1.58-6.47 6.47c.68.27 1.42.49 2.21.49 1.71 0 3.26-.66 4.41-1.74l-1.47-1.47c-.73.82-1.79 1.34-2.98 1.34z"
                        clipRule="evenodd"
                      ></path>
                    </svg>
                  </a>
